...
if [ ! -d "./logs/nll_snMoE_CrossGNN" ]; then
  mkdir ./logs/nll_snMoE_CrossGNN
fi
gpu=2
...
for tk in  5 ; do
  for pred_len in 96   ; do   # 
      ...
      --learning_rate 0.01 \
      --batch_size 32 \
      --itr 1 >logs/nll_snMoE_CrossGNN/revin0_${model_name}_bohai_${seq_len}_${pred_len}_tk${tk}_k4_3.log
  done
done
